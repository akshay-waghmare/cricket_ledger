...
import { saveAllData, loadMatches, loadUsers } from './utils/data-persistence';
...
export class CricketLedgerService {
   ...
   */
  createMatch(matchId: string, teams: string[]): MatchLedger {
   ...
   */
  saveData(): void {
    saveAllData(this.matches, this.users);
  }
